...
<div class="SessionTemplate fliterPad">
...
Results <b>{{fareFlightSegment.length}}</b> out of <b>{{fareFlightSegment.length}}</b>							
			...
			<aside class="clearfix asideMarginDomestic">
						...
						<div class="panel-heading" role="tab" id="headingTwo">
							<h4 class="panel-title">
								<a role="button" data-toggle="collapse"  
									...
									class="accordion" aria-controls="#collapseTwo"> Fare Type <span><i
										class="tayy tayyarah-keyboard_arrow_right"></i></span>
								</a>
							</h4>
						</div>
								...
								<form class="form-horizontal ">
									<div class="checkbox " data-ng-repeat="airlines in airlinelist">
										<label> <input type="checkbox" class="airlinefilter"
											value="{{airlines}}" name="airlines"
											data-ng-click="airlinefilter(airlines.name)"
											id="name{{airlines.code}}" data-ng-model="todo"><span
											class="checkbox-material"><span class="check"></span></span>
						...
						<div class="panel-heading" role="tab" id="headingFive">
							<h4 class="panel-title">
								<a class="collapsed" role="button" data-toggle="collapse"
									...
									aria-expanded="false" aria-controls="collapseFive"> Depature
									Time <span><i
										class="tayy tayyarah-keyboard_arrow_right"></i></span>
								</a>
							</h4>
							...
							<div class="panel-body">
								<form class="form-horizontal " role="form">
									<div class='priceslider'>
										...
										<span><b class="text-left" id="departMin"></b></span>
										<span><b class="pull-right" id="departMax"></b></span>
						...
						<div class="panel-heading" role="tab" id="headingSix">
							<h4 class="panel-title">
								<a class="collapsed" role="button" data-toggle="collapse"
									...
									aria-expanded="false" aria-controls="collapseFive">Return
									Time <span><i
										class="tayy tayyarah-keyboard_arrow_right"></i></span>
								</a>
							</h4>
							...
							<div class="panel-body">
								<form class="form-horizontal " role="form">
									<div class='priceslider'>
										...
										<span><b class="text-left" id="seconddepartMin"></b></span>
										<span><b class="pull-right" id="seconddepartMax"></b></span>
