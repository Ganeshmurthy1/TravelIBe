...
<div class="col-md-12 col-sm-12 col-xs-12 removeMobPadd">
	<div class="searched-result mobResult">
		...
		<div data-ng-show="loadpricebar" class="hidden-xs">
			...
			<span><b>Please Wait While we are Getting prices and
					availability...</b></span>
		</div>
		<!-- ----------- step result shown here ------------------------  -->
		<div class="clearfix" data-ng-style="{'display' : display}"
			data-ng-cloak>
			<div class="clearfix">
				<s:if
					test="#session['agent'] != null && #session.isCorporate == false || #session.emulateFlag == true ">
						...
						<div class="col-md-12 col-sm-12 col-xs-12 clearfix">
							...
							<ul class="sort-bar clearfix">
								...
								<li><a href="javascript:void(0);"
									class="sort-by-price pull-right"> <label id="mark"
										style="cursor: pointer;">Add Markup</label>
										<form class="form-inline" id="markup"
											...
											<input type="hidden" name="cabinClass" id="markcabinClass"
												...
												name="airlinecode" id="airlinecode" value="all">
				...
				<s:else>
					...
					<div class="sort-by-section clearfix box">
						<div class="col-md-12 col-sm-12 col-xs-12 clearfix">
							...
							<ul class="sort-bar clearfix">
								<li id="offnone" class="col-md-4 col-sm-4 col-xs-3"><a
								...
								<li class="col-md-4 col-sm-4 col-xs-8"><a
									data-target="{{currencyname}}" class="sort-by-container">
										<form
											class="col-md-12 col-sm-12 col-xs-12 form-inline currencyselectform">
											<label class="col-md-5 col-sm-4 col-xs-6 padMobLeft0px">Currency</label>
											<select id="selectcurrencyname"
												class="form-control currencyselect col-md-4 col-sm-4 col-xs-6"
								...
								<li
									class="sort-by-price pull-right col-md-4 col-sm-4 col-xs-1 mobileFont">
			...
			<div class="col-md-12 mobchangeRefine"
				data-ng-hide="hideDiv ||isQuoteAvailable" id="changerefine">
				<div class="col-xs-10 clearfix">
					<!-- <div class="row"> -->
					<div
						class="col-md-3 col-sm-3 col-xs-3 searched-city mobMargin-top-10px">
						<p>
							<b>{{origincodename}} <i class="tayyarah-arrows-h"></i>
								{{destcodename}}
							</b>
					...
					<div class="col-md-3 col-xs-4 col-sm-3 searched-date">
						<div class="row">
							<div class="col-sm-12 hidden-xs">
								...
								<span>{{departuredate | date:'MMM d'}}</span>
							</div>
							<div class="col-sm-12 visible-xs">
								<p class="margin10px">{{departuredate | date:'MMM d'}}</p>
							</div>
						</div>
					</div>
					<!-- searched-date -->
					...
					<div
						class="col-md-5 col-xs-3 col-sm-5 searched-economy mobPadZero ">
						<div class="row">
							...
							<div
								class="col-xs-12 visible-xs hidden-md hidden-sm mobPadZero mobMargin-top-15px">

								<p class="mobsameBlock mobPadZero col-xs-6 ">
									<b class="pull-right ">{{totalpassenger}}</b>
								</p>
								<span class="mobsameBlock visible-xs col-xs-6  "><i
									class="tayyarah-users pull-left" aria-hidden="true"></i></span>
					...
					<div class="row marginBottom">
						<div class="col-md-10 col-sm-10 col-xs-10 clearfix">
							<input type="hidden" id="hideori" value=""> <input
								type="hidden" id="hidedes" value=""> <input
								type="hidden" id="triptype" name="$TT*Y" value="O"> <input
						...
						<div class="col-sm-2">
							<div class="margin">
								<div class="btn-group clean">
									<button type="submit" id="modifiedsearch"
										class="btn btn-info mob-reSearch"
			...
			<div
				class="col-md-12 col-sm-12 col-xs-12 onewayMtrz padLeftRightZero"
				id="max-none">

				<div
					class="col-xs-3 col-sm-2 col-md-2 mtx-list clearfix padLeftRightZero">
				...
				<div
					class="col-xs-9 col-sm-10 col-md-10 clearfix matrix-search mobMatrixSearch padLeftRightZero">
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class=" clearfix">
						...
						<div class="flight-list">
							<div id="nav">
								<div class="flight-booking-heading clearfix">
									<div class="col-sm-1 sortby padLeftRight0">
										<h5>
											<b> Sort by: </b>
										</h5>
									</div>
							...
							<div id="fareflightlist{{groupindex}}"
								...
								class="flightlistcon mobRemoveBorder"
												...
												<label class="block clearfix seglist corporate-hoverable"
													...
													<div class="sin-row">
														<div class="col-sm-6 airlines ">
															...
															<p class="img-airname">
																<span>{{flightSegments.segments[0].carrier.name}}</span>
																<a class="hidden-xs">{{flightSegments.segments[0].carrier.code}}-</a>
																<a class="hidden-xs"
															...
															<a class="complementry hidden-xs "
																data-ng-if="flightSegments.segments[0].carrier.name =='Jet Airways' && !isInternational"><i
																class="toolti tayyarah-cutlery"></i><span
																class="tooltitext">Complimentary Meal/Snacks</span> </a> <a
																class="complementry hidden-xs"
																data-ng-if="flightSegments.segments[0].carrier.name =='Air India' && !isInternational"><i
																class="toolti tayyarah-cutlery"></i><span
														...
														<div class="visible-xs arrive col-xs-1" style="width: 1%;">
													...
													</div> <!-- single-row-ends --> <%-- <a class=complementry data-ng-if="flightSegments.segments[0].carrier.name =='Jet Airways'"><i class="tayyarah-cutlery"></i> <span>Complimentary Meal/Snacks</span></a>
												<a class=complementry data-ng-if="flightSegments.segments[0].carrier.name =='Air India'"><i class="tayyarah-cutlery"></i> <span>Complimentary Meal/Snacks</span></a> --%>
											...
											<div class="book">
												<div class="flight-timings">
													<form data-ng-submit="booknow(groupindex+1)">
														...
														<button type="submit" id="flightonewaybook"
													...
													<div class="flight-timings"
														...
														<div class="hold-free">
															...
															<form data-ng-submit="holdnow(groupindex+1)">
																...
																<input type="hidden" id="adult{{groupindex+1}}"
																	name="at" value="{{adult}}"> <input
																	type="hidden" id="child{{groupindex+1}}" name="cd"
																	value="{{child}}"> <input type="hidden"
																	id="infant{{groupindex+1}}" name="it"
																	value="{{infant}}"> <input type="hidden"
																	id="searchkey{{groupindex+1}}" name="sky"
																	value="{{searchkey}}"> <input type="hidden"
																	id="ccy{{groupindex+1}}" name="ccy"
																...
																<button type="submit"
																	class="btn btn-info bookBtn mobileHoldBtn"
																	ng-click="submitted==true">Hold for Free</button>
															</form>
															<div class="hold-free-hover">Hold seats for free
																till {{ fareFlightSegments.latestTicketingTime |
																date:'EEE, dd MMM yy' }}</div>
														</div>
													</div>
												</s:if>
												<a class="col-xs-12 mobPadZero FareModalInline"
													...
													<div class="m-price">
														<form data-ng-submit="booknow(groupindex+1)">
															...
															<input type="hidden" id="bookingtype{{groupindex+1}}"
																...
																id="app_key{{groupindex+1}}" name="ay"
																value="{{app_key}}"> <i
																data-ng-class="classname"></i>{{getconvertedcurrency(totalprice)}}
															<span class="block"> <input
																id="flightonewayselect" class="btn btn-info btn-clean"
												...
												<div class="tab-content" id="mode-cont">
													<div role="tabpanel" class="tab-pane active" id="home">
														...
														<div class="model-main-details"
															...
															<div class="d-h-air">
																<ul class="col-xs-12 mod-f-details clearfix">
																	<li class="col-xs-3 mobLi100Per mobCabin">
																		<figure>
																			<span
																	...
																	<li class="col-xs-3 mod-dep mobLi40Per">
																	...
																	<li class="col-xs-1 module-direction">
																		<div>
																			<p class="m-rou ">
																				<i class="tayyarah-long-arrow-right"></i>
																			</p>
														...
														<div class="clearfix">
															<div class="col-sm-12 m-baggage">
																...
																<div class="m-baggage-cont clearfix">
																	...
																	<div class="col-sm-3 mob-bag col-xs-6">
																		<p>Cabin</p>
																		<span>5-7 Kg</span>
																	</div>
																	<div class="col-sm-3 mob-bag col-xs-6">
																		<p>Checkin</p>
																		<span
																			ng-if="baggagevalue =='No Information Available'">{{baggagevalue}}</span>
																		<span
																			ng-if="baggagevalue !='No Information Available'">{{baggagevalue}}
																			Kg</span>
																	</div>
																</div>
															</div>
							...
							<s:if test="#session['agent'] != null">
								<div class="corporate-quotation-list"
									...
									<div class="modal left fade onewayQuoteModal"
										id="myModalQuotation" role="dialog">
														...
														<ul>
															<li class="qoute-list"><span class="q2">{{$index
																...
																<span class="q2">Flight No:
																	{{quote.flightNumber}} </span> <span class="q2">Duration:
																	{{quote.totalDuration}} </span><span class="q2">Price:
																	<i class="tayyarah-inr"></i><span class="q1"><b>{{quote.totalAmount}}</b></span>
										...
										<div class="modal-body "
											...
											<div class="row">
												...
												<button type="button" class="btn btn-default "
													style="margin-left: 40px; border: 1px solid #ccc; margin-top: 40px;"
					...
					<div>
						<div class="row"
							data-ng-if="(fareFlightSegment | filter:filterprice |
											filter:StopsFilter| filter:AirlineFilter |
											filter:MatrixAirlineFilter | filter:FareTypeFilter).length== 0">
							<div class="greyBorder ">
								<p class="GreyBackground text-center ">We couldn't find
									Flights matching your preferences</p>
								<div class="col-md-12 margintop10px text-center"></div>
							</div>
						</div>
					</div>
				</div>
