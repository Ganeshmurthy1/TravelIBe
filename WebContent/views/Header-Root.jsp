								...
								<s:elseif test="#session['agent'] != null">
									...
									<li class="dropdown"><a href="#" class="dropdown-toggle"
										data-toggle="dropdown">Welcome &nbsp<s:property
												value="#session.agent.Username" /> <b class="caret"></b></a>
										<ul class="dropdown-menu">
					...
					<div class="logo">
						<h1>
							<a class="imgSiz" data-ng-href="#flights"
								...
								class="img-responsive logoImage" ng-src="{{Companylogo}}"></a>
						</h1>
					</div>
							...
							<ul
								...
								<li data-ng-class="{ active: isActive('/bus')}"><a
									...
									data-ng-click="returnBusIndex()"><i
										class="visible-xs-inline"></i><img class="busimg  "></img> <Span>Buses</Span></a></li>
								<li data-ng-class="{ active: isActive('/cars')}"><a
									data-ng-href="#/cars" return="false"><i
										class="visible-xs-inline"></i><img class="carimg  "></img> <Span>Cars</Span></a></li>
							...
							<ul
								...
								<li data-ng-class="{ active: isActive('/cars')}"><a
									data-ng-href="#/cars"><i class="visible-xs-inline"></i><img
										class="carimg  "></img> <Span>Cars</Span></a></li>
								<li data-ng-class="{ active: isActive('/about')}"><a
