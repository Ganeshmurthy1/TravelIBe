	...
	<div>
		<div class="container">
			<div class="booking-details clearfix minheight250px"
				...
				<aside class="col-sm-3 " data-ng-show="fareloader" data-ng-cloak>
				...
				<div class="col-md-9 col-sm-9 col-xs-12 mob-padRemove">
							...
							<div class="panel panel-default traveler-details">
								...
								<div class="panel-body">
									<input type="hidden" id="isCardAcess"
										value="<s:property value="%{#session.isCardAcess}"/>">
									<input type="hidden" id="selectedpaymode" value="wallet">
									...
									<input type="hidden" name="pky" id="pricekey"
										value="{{pricekey}}"> <input type="hidden"
										name="adult" id="adult" value="{{adult}}"> <input
										type="hidden" name="child" id="child" value="{{child}}">
									...
									<input type="hidden" name="tp" id="totpr"
										...
										type="hidden" name="tpay" id="totpay"
										value="{{totalpayableamt}}"> <input type="hidden"
										id="dammytotpay" value="{{totalpayableamt}}">
									...
									<div class="adult clearfix mob-Adult"
										...
										<div class="form-group clearfix">
											...
											<input type="hidden" class="form-control" name="admN"
										...
										<div class="form-group clearfix" data-ng-if="isInternational">
											<label for="exampleInputName2">Passport No</label> <input
												type="text" class="form-control" name="adppN"
												ng-model="pass2" maxlength="18"
												onkeypress="return IsAlphaNumeric(event)" autocomplete="off"
												placeholder="Passport No" id="passport-{{$index}}"
														...
														<div class="form-group clearfix" id="bag"
															...
															<label>Extra Baggage</label> <select class="form-control"
																...
																<option data-ng-repeat="baggage in baggagelist"
																	...
																	value="{{baggage.Code}}" id="bagCode">{{baggage.Weight}}
									...
									<div class="adult clearfix mob-Adult"
										data-ng-repeat="child in childarray"
										data-ng-class="isdomestic">
										<div class="form-group clearfix tile-bd1">
										...
										<div class="form-group newClearFix clearfix">
											<label for="inputEmail3">Given / First Name</label> <input
												...
												maxlength="18" data-ng-model="chmnName"
								...
								value="11/03/1995"> -->
										...
										<div class="form-group newClearFix clearfix dateLength">
											<label for="inputEmail3">Date of birth</label> <input
												type="text" class="form-control datePickChild"
										...
										<div class="form-group newClearFix clearfix"
											...
											<label for="exampleInputName2">Passport No</label> <input
												type="text" class="form-control" name="chppN"
												ng-model="pass3" maxlength="18"
												...
												<div class="collapse " id="childdeparture{{$index}}">
													<div>
														<div class="form-group clearfix"
															...
															<label>Meal</label> <select class="form-control "
																...
																<option data-ng-repeat="meal in meallist"
																	...
																	id="mealitem{{$index}}">{{meal.Description}} -
																	Rs {{meal.Price}}</option>
															</select>
														...
														<div>
															...
															<div class="form-group clearfix"
																data-ng-if="baggagelist.length > 0">
																<label>Extra Baggage</label> <select
																	class="form-control" name="chbaggagecode"
																	id="baggitem{{$index}}"
																	onchange="addprice('childbaggage',this);">
																	<option data-ng-repeat="baggage in baggagelist"
																		itemprice="{{baggage.Price}}"
																		itemweight="{{baggage.Weight}}"
																		value="{{baggage.Code}}">{{baggage.Weight}}
																		KG - Rs {{baggage.Price}}</option>
																</select>
									...
									<div class="adult clearfix mob-Adult"
										...
										<div class="form-group newClearFix clearfix">
											<label for="inputEmail3">Given / First Name</label> <input
												...
												id="infantFname-{{$index}}" placeholder="Given Name"
												required autocomplete="off" maxlength="18"
												onkeypress="return isAlphabetKey(event,this);"
												data-ng-model="infantFname" data-ng-required="true">
											<input type="hidden" class="form-control" name="inmN"
										...
										autocomplete="off" > -->
											<input type="text" class="form-control datePickInfant"
												id="infantdate{{$index}}" onkeydown="return false;"
										...
										<div class="form-group newClearFix clearfix "
											data-ng-if="isInternational">
											<label for="exampleInputName2">Passport No</label> <input
												type="text" class="form-control" name="inppN"
												ng-model="pass1" maxlength="18" id="inppNo{{$index}}"
												onkeypress="return IsAlphaNumeric(event)" autocomplete="off"
												placeholder="Passport No" data-ng-required="true">
										</div>
									</div>
											...
											<div class="row">
												<s:if test="#session.isCorporate == true">
													...
													<div class="biiling-bd2" data-ng-if="department">
														<div class="form-group clearfix bii-bd">
															<label for="exampleInputName2">Department</label> <input
																...
																placeholder="Department" ng-model="department"
																data-ng-required="true" autocomplete="off">
														</div>
													</div>
													...
													<div class="biiling-bd2" data-ng-if="costCenter">
														<div class="form-group clearfix bii-bd">
															<label for="exampleInputName2">Cost Center</label> <input
																...
																placeholder="Cost Center" ng-model="costCenter"
																data-ng-required="true" autocomplete="off">
														</div>
													</div>
													<div class="biiling-bd2" data-ng-if="approverName">
														<div class="form-group clearfix bii-bd">
															<label for="exampleInputName2">Approver Name</label> <input
																...
																placeholder="Approver Name" ng-model="approver"
																data-ng-required="true" autocomplete="off">
														</div>
													</div>
													...
													<div class="biiling-bd2" data-ng-if="reasonForTravel">
														<div class="form-group clearfix bii-bd">
															<label for="exampleInputName2">Reason for travel</label>
															<input type="text" class="form-control NameFontMAnl"
																name="reason" id="reason"
																placeholder="Reason for travel" ng-model="Reason"
																data-ng-required="true" autocomplete="off">
														</div>
													</div>
													<div class="biiling-bd2" data-ng-if="billNonBill">
														<div class="form-group clearfix bii-bd">
															<label for="exampleInputName2">Billable/ non
																...
																id="billingCode" placeholder="Billable/ non billable"
																ng-model="billingcode" data-ng-required="true"
																autocomplete="off">
														</div>
													</div>
												</s:if>
											...
											<b> Terms & Conditions</b><br> <label>
												<p>
													<input type="checkbox" id="field_terms" required
														...
														booking this ticket, abide by cancellation & booking
														policies.
													</span>
												</p>
										...
										<div class="modal-dialog modal-lg" role="document">
											<div class="modal-content" id="model-f-d">
												...
												<div class="modal-body">
													...
													<ul>
														<li>Fares are subject to availability. If there is
															any fare change we will notify you immediately.</li>
														...
														<li>The primary guest must be at least 18 years of
															age to check into this hotel</li>
														<li>It is mandatory for all guests above 18 years of
															...
															a refund &amp; your booking will be considered as NO
															SHOW.</li>
														...
														<li>If you wish to book multiple rooms, you must use
															a different name for each room or the duplicate
															reservation may be cancelled by the hotel.</li>
														...
														<li>The standard check-in time is 12:00 PM and the
															...
															may be chargeable by the hotel. Any early check-in or
															late check-out request must be directed and reconfirmed
															with hotel directly.</li>
													</ul>
												</div>
											</div>
										</div>
	...
	$('#Cardoption')
			.on(
					...
					function() {
						...
						addedpercent = parseFloat(Math.ceil(addedpercent))
								.toFixed(2);
						...
						$("#cardOption").show();
						angular.element(
								document.getElementById('B2Bothercharges'))
								.scope().addcardchargesforagent(true,
										addedpercent, totflightprice,
										paymentgatewayprice);
	...
	$('#Walletoption')
			.on(
					...
					function() {
						...
						$('#totpay').val(
								parseFloat(paymentgatewayprice).toFixed(2));
						...
						angular.element(
								document.getElementById('B2Bothercharges'))
								.scope().addcardchargesforagent(false, 0,
										totflightprice, paymentgatewayprice);
					});
</script>
