<%@taglib prefix="s" uri="/struts-tags"%>
 ...
 <span><b>Getting prices and availability...</b></span></div>
			<!-- ----------- step result shown here ------------------------  -->
<div class="clearfix displayRigthPAd" data-ng-style="{'display' : display}" data-ng-cloak>
		<div class="row" id="changerefine" data-ng-show="isQuoteAvailable">
			...
			<div class="row removeBorder-Right" id="changerefine" data-ng-hide="hideDiv || isQuoteAvailable">
				<div class="col-md-10 col-sm-10 col-xs-10 clearfix">
					<div class="row">
						<div class="col-md-3 col-sm-3 col-xs-3 searched-city pad-LR-Zero marginMobTop">
							<p>
								<b>{{origincodename}} <i class="tayyarah-arrows-h"></i>
									{{destcodename}}
								</b>
						...
						<div class="col-md-4 col-sm-4 col-xs-3 searched-economy pad-LR-Zero">
							<div class="row">
								...
								<div class="col-md-6 col-sm-6 col-xs-6 mobPadZero mobMargin-top-15px hidden-md hidden-sm visible-xs">
								
							<span>{{totalpassenger}}</span><span><i class="tayyarah-users" aria-hidden="true"></i></span>
							</div>
							</div>
						</div>
					</div>
			...
			<div class="clearfix offcanvas" data-ng-show="showDiv" id="searchrefine">
				...
				<form name="flightsearchForm" id="searchagain"
					...
					<input type="hidden" id="hideori" value="">
                        ...
                        <input type="hidden" id="cabinselect" value="All">
						<input type="hidden" name="triptype" id="triptype" value="R">
						<input type="hidden" name="airlinecode" id="airlinecode"
							value="all"> <input type="hidden" value="M"> <input
							type="hidden" name="isDynamicmarkup" value="false"
							...
							<div class="form-group">
								<div class="input-group">
									<input type="text" name="ori" data-ng-model="twoorigin"
										id="originid" autocomplete="off" onkeypress="return isAlphabetKeywithspace(event,this);"
							...
							<div class="form-group">
								<div class="input-group">
									<input type="text" name="des" id="destinationid"
										...
										typeahead="c as c for c in cities($viewValue)  | limitTo:10"
										typeahead-min-length='1' onkeypress="return isAlphabetKeywithspace(event,this);"
										typeahead-on-select='onSelectPart($item, $model, $label)'
										typeahead-template-url="customTemplate.html"
										class="form-control" required>
								</div>
			...
			<div class="clearfix">
				<s:if test="#session['agent'] == null || #session.isCorporate == true">
							...
							<li id="offnone"><a 
								...
								<li><a href="javascript:void(0);" class="sort-by-container">
										<form class="form-inline">
											<label>Currency</label> <select id="selectcurrencyname" class="form-control spclcurrency"
									...
									class="sort-by-price pull-right"> <label id="mark">Add
										...
										<form class="form-inline" id="markup"
											...
											<input type="hidden" name="cabinClass" id="markcabinClass"
												...
												value="{{markupammount}}">
											<button class="btn btn-info but btn-clean mobile-inline" type="submit"
												id="submitmarkup" ng-click="submitted==true">Add</button>
										</form>
								</a></li>
			...
			<div class="clearfix special-round-selection">
				<div class="clearfix col-sm-12" id="sele-summary"
					...
					<div class="clearfix current-section">
						<div class="col-md-6 col-sm-6 col-xs-6 brrt pad-Left-Right-10px" class="selecedradio content">
									...
									<ul class="clearfix c-dir">
										...
										<li class="col-md-4 col-sm-4 col-xs-4"><p>
												<b>{{selectedonwardflight.segments[selectedonwardflight.segments.length
													- 1].dest}}</b>
											</p> <span>{{selectedonwardflight.segments[0].arrTime}}</span></li>
									</ul>
								</li>
								<li class="c-air-image">
									<p>
										<b>{{selectedonwardflight.segments |
									...
									<ul>
										...
										<li class="col-md-4 col-sm-4 col-xs-4"><p>
												<b>{{selectedreturnflight.segments[selectedreturnflight.segments.length
													- 1].dest}}</b>
											</p> <span>{{selectedreturnflight.segments[0].arrTime}}</span></li>
									</ul>
								</li>
								<li class="c-air-image">
									<p>
							...
							<a href="javascript:void(0);" data-toggle="modal" class="sh-det"
								...
								<form data-ng-submit="booknow(groupindex+1)">
									...
									<input type="hidden" name="ccy" id="ccy{{groupindex+1}}"
										...
										id="app_key{{groupindex+1}}" value="{{app_key}}">
											 <input id="flightspclbook" class="btn btn-info but btn-clean button-dropdown" type="submit" name="Book" value="Book" data-ng-hide="bookNowButtonQuotation">
										     <s:if test="#session['agent'] != null">
															<button type="button" id="QuoteClick" class="btn btn-info bookBtn quoteBtnn" data-ng-show="isQuoteAvailable"
															data-ng-click="addtoquotelist(selectedonwardflight,selectedreturnflight)">Quote Now</button>
															</s:if>
			...
			<div class="col-md-6 col-sm-6 col-xs-6 domestic-round-trip padLeft0px clearfix">
				<div class="flight-list flight-list-background">
					...
					<div class="f-domestic-ro clearfix flightlistcon"
						id="fareflightlist{{groupindex}}" data-ng-show="isShowable(groupindex);"
						...
						<div class="flight-booking-list flight-booking-list-Border clearfix"
							...
							<label class="block clearfix"
								...
								<div class="sin-row">
									<div class="col-md-4 col-sm-4 col-xs-12 airlines">
										...
										<a class="complementry" data-ng-if="flightSegments.segments[0].carrier.name =='Jet Airways'"><i class="toolti tayyarah-cutlery"></i><span class="tooltitext">Complimentary Meal/Snacks</span> </a>
		                                <a class="complementry" data-ng-if="flightSegments.segments[0].carrier.name =='Air India'"><i class="toolti tayyarah-cutlery"></i><span class="tooltitext">Complimentary Meal/Snacks</span> </a>
										</div>
									</div>

									<div class="col-md-2 col-sm-2 col-xs-6 departure">
									...
									<div class="arrive col-md-2 col-sm-2 col-xs-6">
										<div class="flight-timings">
											<p class="h4">
									...
									<div class="duration col-md-2 col-sm-2 col-xs-2">
										<div class="flight-timings">
											<p class="h4">
									...
									<div class="duration pricebar-two col-md-2 col-sm-2 col-xs-12">
			...
			<div class="col-md-6 col-sm-6 col-xs-6 domestic-round-trip padright0px clearfix">
				<div class="flight-list flight-list-background">
					<div>
						<div class="flight-booking-heading padding10px clearfix">
							<div class="airlines col-xs-2">
						...
						<div class="flight-booking-list flight-booking-list-Border clearfix"
							...
							<label class="block clearfix"
								...
								<div class="sin-row1">
									...
									<div class="duration pricebar-two col-xs-2">
										<div class="flight-timings mobfont600">
											<i data-ng-class="classname"></i>
											<!-- {{getconvertedcurrency(fareFlightSegments.totalPrice)}} -->
											{{numberWithCommas(getconvertedcurrency(fareFlightSegments.totalPrice))}}
							...
							<div class="mod-fli-de clearfix">
								...
								<p>
									...
									<form data-ng-submit="modalbooknow(groupindex+1)">
										...
										value=""> <input type="hidden" name="ay"
										id="app_key{{groupindex+1}}" value="{{app_key}}">
											 <input id="flightspclselect" class="btn btn-info but btn-clean button-dropdown" type="submit" name="Select" value="Select">
															...
															<div class="d-h-air">
																<ul class="mod-f-details clearfix">
																	...
																	<li class="mod-dep mobLi40Per">
																		<h5 class="col-xs-12">{{seg.oriName}}( {{seg.ori}} )</h5> <time class="col-xs-12">{{seg.depDate
																	...
																	<li class="mod-dep mobLi40Per">
																		<h5 class="col-xs-12">{{seg.destName}} ( {{seg.dest}})</h5> <time class="col-xs-12">{{seg.arrDate
																	...
																	<li class="module-direction mobLi100Per">
																		<h5>
																			<i class="tayyarah-clock-o"></i> {{seg.duration |
														...
														<div class="model-main-details">
															<div class="d-h-air">
																<ul class="mod-f-details clearfix">
																	...
																	<li class="mod-dep mobLi40Per">
																		<h5>{{seg.oriName}}( {{seg.ori}} )</h5> <time class="col-xs-12">{{seg.depDate
																			| date:'EEE, dd MMM'}}</time> <time class="col-xs-12">Departure :
																			{{seg.depTime }}</time>
																		<h6 class="col-xs-12">{{seg.oriAirportName}}</h6>
																	</li>
																	...
																	<!-- replacetimeformat( -->
																	<li class="mod-dep mobLi40Per">
																		<h5>{{seg.destName}} ( {{seg.dest}})</h5> <time class="col-xs-12">{{seg.arrDate
																			|date:'EEE, dd MMM'}}</time> <time class="col-xs-12">Arrival :
																			{{seg.arrTime }}</time>
																		<h6 class="col-xs-12">{{seg.destAirportName}}</h6>
																	</li>
			...
			<!-- Admin Redirect model  -->
							...
							<div class="modal-dialog">
								...
								<div class="modal-content">
									...
									<button type="button" class="btn btn-primary " data-ng-click="addquotes()">yes</button>
										<button type="button" class="btn btn-default " style="margin-left:40px;border:1px solid #ccc;"data-dismiss="modal">No</button></div>
									</div>
		...
		<div class="modal fade" id="InfoModal" role="dialog">
							<div class="modal-dialog modal-sm">
								...
								<div class="modal-content">
									...
									<div class="modal-body " style="margin-top:20px !important;padding-top:10px !important;">
										...
										<!-- <div class="row">
									<button type="button" class="btn btn-primary " style="margin-left:0px;" data-ng-click="addtoquotelist(fareFlightSegments)">Continue</button>
										<button type="button" class="btn btn-default " style="margin-left:40px;border:1px solid #ccc;" data-dismiss="modal">Add More</button>
										</div> -->
							</div>									
					</div>
				</div>
					...
					<div class="corporate-quotation-list" data-ng-show="isQuoteAvailable">
						<!-- <button type="button" class="btn btn-info btn-lg" id="myQuotation">
							...
							<button type="button" class="btn btn-info btn-lg" id="myQuotation">
							<span class="hidden-xs">Your Quotation List </span> 
							<i class="tayyarah-th visible-xs quot-list" >
							<span class="padrigth10px">Quote List</span></i></button>
							...
							<div class="modal-dialog">
										...
										<div data-ng-repeat="quote in quotearray track by $index">
											<ul>
												<li class="qoute-list"><span class="q2">{{$index
													...
													<span class="q2">Price: <i class="tayyarah-inr"></i><b>{{quote.totalAmount}}</b></span>
								...
								<div class="modal-footer">
									...
									<button type="button" class="btn btn-primary"
										data-ng-click="addquotesModal()" data-ng-show="isQuoteloaded">Add Quotation</button>
								</div>
							</div>
						</div>
					</div>
     ...
     <!--  Modal content -->
      <div class="modal-content">
        ...
        <div class="modal-body">
         	<div class="row">
         	<div class="col-md-12">
         	<div class="row reviewRow"><div class="domesticlowpriceRed">Selected Flight</div> </div>
         	 <div class="sin-row row">
									<div class="col-md-4 col-sm-4 col-xs-12 airlines selectedDivBorder">
										<div class="pull-left">											
										</div>
										
										<div class="sprite-carrier-sec">
											<span class="spriteFltLogos x{{selectedflight.flightSegmentsGroups[0].flightSegments[0].segments[0].carrier.code}}"></span>
										...
										<a class="complementry" data-ng-if="selectedflight.flightSegmentsGroups[0].flightSegments[0].segments[0].carrier.name =='Jet Airways'"><i class="toolti tayyarah-cutlery"></i><span class="tooltitext">Complimentary Meal/Snacks</span> </a>
		                                <a class="complementry" data-ng-if="selectedflight.flightSegmentsGroups[0].flightSegments[0].segments[0].carrier.name =='Air India'"><i class="toolti tayyarah-cutlery"></i><span class="tooltitext">Complimentary Meal/Snacks</span> </a>
										</div>
									</div>

									<div class="col-md-2 col-sm-2 col-xs-6 departure selectedDivBorder">
										<div class="flight-timings">
											<p class="h4">
									...
									<div class="duration col-md-2 col-sm-2 col-xs-2 selectedDivBorder">
										<div class="flight-timings">
											<p class="h4">
												<i class="tayyarah-clock-o"></i>{{selectedflight.flightSegmentsGroups[0].flightSegments[0].segments |
												totaltime:'mm':'hhhmmm':false}}
											</p>
											<span data-ng-show="selectedflight.flightSegmentsGroups[0].flightSegments[0].segments.length == 1">{{selectedflight.flightSegmentsGroups[0].flightSegments[0].segments.length
												- 1}} Stop</span> <span
									...
									<div class="duration pricebar-two col-md-2 col-sm-2 col-xs-12 selectedDivBorder text-center">
										<div class="flight-timings mobfont600 ">
											<i data-ng-class="classname"></i>											
         	...
         	<div class="row reviewRow"><div class="domesticlowpriceGreen">Recommended Flights</div> 
         	<div class="f-domestic-ro clearfix flightlistcon"
						id="fareflightlist{{groupindex}}" data-ng-show="isShowable(groupindex);"
						...
						<div class="flight-booking-list domflight-booking-list flight-booking-list-Border clearfix"
							data-ng-repeat="(index,flightSegmentsGroups) in fareFlightSegments.flightSegmentsGroups">
							<label class="block clearfix"
								id="seggroupchild{{fareFlightSegments.id}}"
								data-ng-repeat="(segindex,flightSegments) in flightSegmentsGroups.flightSegments | filter:StopsFilter| filter:AirlineFilter | filter:MatrixAirlineFilter">
								<div class="sin-row">
									<div class="col-md-4 col-sm-4 col-xs-12 airlines">
										 <div class="pull-left" data-ng-if="FlightType == 'onwardFlight'">
											<input id="onwardselected" type="radio"
												name="selectedonwardflight"
												data-ng-click="selectonwardflight(flightSegments,fareFlightSegments);"
												>
										</div> 
										<div class="pull-left" data-ng-if="FlightType == 'returnFlight'">
											<input type="radio" id="returnselected"
												name="selectedreturnflight"
												data-ng-click="selectreturnflight(flightSegments,fareFlightSegments);"
												>
    ...
    <div  ng-init="value = 1"  class="col-md-12 col-sm-12 col-xs-12 reviewRow">
    
    <div class="row ">
     <div class="col-md-4 col-sm-4 col-xs-4 padZero">
     <input id="radio1" type="radio" class="inlineradio" name="radio" value="1" ng-model="value" ng-change='newValue(value)' required>
      <label for="radio1" class="inlineradio">Does not suit my schedule</label> 
     </div>
     <div class="col-md-4 col-sm-4 col-xs-4 padZero">
     <input id="radio2" type="radio" name="radio" class="inlineradio" value="2" ng-model="value" ng-change='newValue(value)' required>
     <label for="radio2" class="inlineradio">Penalty/Refund restriction</label>
     </div>
     <div class="col-md-4 col-sm-4 col-xs-4 padZero">
     <input id="radio3" type="radio" name="radio" class="inlineradio" value="3" ng-model="value" ng-change='newValue(value)' required>
     <label for="radio3" class="inlineradio">Alternate corporate preferred fare selected </label>
    </div>
    </div>
     <div class="row  ">
     <div class="col-md-4 col-sm-4 col-xs-4 padZero">
     <input id="radio4" type="radio" name="radio" class="inlineradio" value="4" ng-model="value" ng-change='newValue(value)' required>
     <label for="radio4" class="inlineradio">Policy exception approval obtained</label>
     </div>
     <div class="col-md-4 col-sm-4 col-xs-4 padZero">
     <input id="radio5" type="radio" name="radio" class="inlineradio" value="5" ng-model="value" ng-change='newValue(value)' required>
     <label for="radio5" class="inlineradio">Personal preference </label>
     </div>
     <div class="col-md-4 col-sm-4 col-xs-4 padZero">
     <input id="radio6" type="radio" name="radio" class="inlineradio" value="6" ng-model="value" ng-change='newValue(value)' required>
     <label for="radio6" class="inlineradio">Location does not suit me </label>
    </div>
    </div>
     <div class="row padZero">
     <div class="col-md-4 col-sm-4 col-xs-4 padZero">
    <input id="radio7" type="radio" name="radio" class="inlineradio" value="7" ng-model="value" ng-change='newValue(value)' required>
    <label for="radio7" class="inlineradio">Compliant to the company Travel Allowance Policy </label>
    </div>
    <div class="col-md-5 col-sm-5 col-xs-5 padZero">
    
    <input id="radio8" type="radio" value="8" class="inlineradio" name="radio" ng-model="value" ng-change='newValue(value)' required>
    <label for="radio8" class="inlineradio">Any other Reason</label>
    <input id="resText" type="text" name="resText" value="" disabled style="margin-right: 40px;"> 
    </div>
    </div> 
     </div> 
  <button class="btn btn-default bordergrey"  data-dismiss="modal">Cancel</button>
           ...
           <button class="btn btn-info mobContinue" ng-click="continueonWardBooking(FlightType)">Continue</button>
    </form>
	...
	<div class="container errorPageHeight" data-ng-show="errordiv" data-ng-cloak>
			...
			<div class="visible-xs gradient-error">
						<div class="spinner-error-mess"> 
							<div class="cont_error"> 
								<h1>Oops !</h1> 
								<h2><i class="tayyarah-frown-o" aria-hidden="true"></i></h2> 
							    <p>Some thing went wrong.</p>
								<form data-ng-submit="returnIndex()">
									<button type="submit" data-ng-click="submitted == true" class="btn btn-primary btn-xs  ">Search again</button>
									</form> 
							 </div> 
						</div>
					</div>
