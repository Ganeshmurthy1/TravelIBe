...
<div class="col-md-12 col-sm-12 col-xs-12 mainContentHotelHeight500px"
	...
	<div class="scrollHotelTrails">
			...
			<div class="col-md-10 col-sm-10 col-xs-12 clearfix">
				<div class="row">
					<div class="col-md-3 col-sm-3 col-xs-12 searched-city padLR0Px">
						<span class="col-md-12 col-sm-12 col-xs-3 padLR0Px font600">City</span>
						<p class="col-md-12 col-sm-12 col-xs-9 searchCity padLR0Px">
							{{searchcityname}}</p>
					</div>

					<div class="col-md-2 col-sm-2 col-xs-12 searched-date padLR0Px">
						<span class="col-md-12 col-sm-12 col-xs-3 padLR0Px font600">Check-In</span>
					...
					<div class="col-md-2 col-sm-2 col-xs-12 searched-date padLR0Px">
						...
						<span class="col-md-12 col-sm-12 col-xs-3 padLR0Px font600">Check-Out</span>
						<p class="col-md-12 col-sm-12 col-xs-9 padLR0Px">
							<span>{{dateend}}</span>
						</p>
					...
					<div class="col-md-5 col-sm-5 col-xs-12 searched-economy padLR0Px">
						...
						<span class="col-md-12 col-sm-12 col-xs-3 padLR0Px font600">Detail</span>
						<p class="col-md-12 col-sm-12 col-xs-9 padLR0Px">
				...
				<div class="margin">
					<div class="button-group clean">
						<a class="btn btn-info btn-clean button-dropdown hidden-xs"
							id="changebutton" data-ng-click="modifySearch()" data-ng-show="modifyHotel"> <span
							...
							<div class="hotel-repeat ">
								...
								<div class="clearfix text-right">
									<%-- <s:if test="#session.isCorporate == true">
											<button type="button" class="btn btn-info-corporate"
		...
		<div class="clearfix">
			<div class="col-xs-12 clearfix hotelpadding">
				<s:if
					test="#session['agent'] == null || #session.isCorporate == true">
					<div class="row clearfix" data-ng-hide="HotelFoundBar">
						<div class="clearfix">
							<div class="sort-by-section col-xs-12 clearfix box">
								<div class="found-details col-xs-6 col-sm-6 clearfix">
								...
								<div class="col-xs-6 visible-xs MobFil" id="offnone">
									<a class="sort-by-container clearfix"> <span
										class="offcanvas__trigger--open h-filters filterone"
										data-rel="one"><i class="tayyarah-th"></i>Filters</span>
									</a>
								</div>
								<ul class="sort-bar clearfix block-sm col-xs-12 col-sm-6">
									<li class="hidden-xs" id="offnone"><a
										class="sort-by-container clearfix"> <span
											class="offcanvas__trigger--open h-filters filterone"
											data-rel="one"><i class="tayyarah-th"></i>Filters</span>
									</a></li>
									<li class="sort-by-name s-price"><a href=""
										data-ng-click="pricesort(Roomstaylist)"
										class="sort-by-container"> Price <i
											data-ng-class="priceasc"></i></a></li>

									<li class="sort-by-name">Sort by : <a href=""
										data-ng-click="starsort(Roomstaylist)"
										class="sort-by-container"> Stars <i
											data-ng-class="priceasc"></i></a></li>
								</ul>
							</div>
						</div>
				...
				<div class="row"
					data-ng-if="(Roomstaylist | filter:filterprices |filter:LocationFilter | filter:AmenitiesFilter |filter:RatingFilter | filter:HotelnameFilter).length == 0 || hotelMode == 'OFFLINE'">
					<div class="greyBorder">
						<p class="GreyBackground text-center">We couldn't find Hotels
							matching your preferences</p>
						<div class="col-md-12 margintop10px text-center"
							data-ng-if="dataRating == true && dataMode == false">

							<p class="inlineP  pad10px"
								data-ng-click="resetLastFilters(Filtervalue)">RESET Last
								FILTERS</p>
							<p class="inlineP pad10px">/</p>
							<p class=" inlineP pad10px"
								data-ng-click="resetAllFilters(Filtervalue,hotelMode)">RESET
								ALL FILTERS</p>
						</div>
						<div class="col-md-12 margintop10px text-center"
							data-ng-if="dataRating == false && dataMode == true">

							<p class="inlineP  pad10px"
								data-ng-click="undoHotelModeFilters(hotelMode)">RESET Last
								FILTERS</p>
							<p class="inlineP pad10px">/</p>
							<p class=" inlineP pad10px"
								data-ng-click="resetAllFilters(Filtervalue,hotelMode)">RESET
...
<div class="col-md-12 col-sm-12 col-xs-12 errorPageHeight"
	data-ng-show="errordiv" data-ng-cloak>
