					...
					<ul>
						...
						<s:if test="#session['agent'] == null">
							...
							<li id="login"><a data-toggle="modal"
								...
								class="b2bHAnd">B2B Login </a> <!-- data-toggle="modal" data-target="#welcomeagent" -->
...
%>
							...
							<li id="login">
								<!-- <a data-toggle="modal" href="javascript:void(0);" data-ng-click="openLogin()">B2B Login</a>data-toggle="modal" data-target="#welcomeagent"
                                               <div class="featherlight light" style="display: none;" >
 --> <a data-toggle="modal" data-target="#welcomeagent"
								ng-click="corporatelogin()" class="b2bHAnd"> Corporate Login</a>
