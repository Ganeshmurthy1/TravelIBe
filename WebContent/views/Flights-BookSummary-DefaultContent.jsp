...
<%-- <input type="text" name="companyId" id="compId"	value="<s:property value="%{#session.agent.Companyid}"/>"> --%>
<div class="col-md-12 col-sm-12 col-xs-12 mob-padRemove">
	<div class="clearfix fareBreakFlight visible-xs">
		<div id="offnone">
										...
										<div class="mod-price">
											...
											<div class="m-price">
												<p class="h4">
													...
													{{getbasecurrencyvalue(totalpayableamt,fareflightsegment.exchangeRate)}}
									...
									<div class="round-trip">
										<div class="d-h-air">
											<ul class="mod-f-details clearfix">
												...
												<li class="module-direction">
													<h5>
														<i class="tayyarah-clock-o"></i> {{duration[index]}}
													</h5> <span>Non Stop</span>
												</li>
	...
	<div data-ng-show="mainContentToLoad">
		<form class="form clearfix" name="FlightSummary">
			<div class="panel panel-default traveler-details">
				...
				<div class="panel-body">
					...
					<div class="adult clearfix mob-Adult"
						...
						<div class="form-group clearfix">
							<label for="AdFirstName">Given / First Name</label>
							 <input
								type="text" class="form-control" name="adfN"
								id="AdFirstName-{{$index}}" placeholder="Given Name"
								maxlength="18" required 
								onkeypress="return isAlphabetKey(event,this);"
								data-ng-model="AdFirstName" data-ng-required="true" 
								>
								 <input
								type="hidden" class="form-control" name="admN"
								id="MiddleName-{{$index}}" placeholder="Middle Name"
						...
						<div class="form-group newClearFix clearfix dateLength"
							data-ng-show="Isinsurance && Isinsurance!=undefined">
							<label for="inputEmail3">Date of birth</label> <input type="text"
								class="form-control datePickAdult insuranceDobClick"
								id="Adultdate{{$index}}" placeholder="DOB"
								onkeydown="return false;" data-ng-required="true"
								data-ng-click="InsurancecallApi($index)" />
						</div>
						<input type="hidden" class="form-control" name="empId"
								id="employeeID{{$index}}" placeholder="employeeId"
								value="empid" >
						<div class="form-group clearfix tile-bd"
							data-ng-show="Isinsurance && Isinsurance!=undefined">
							<label for="exampleInputName2">Insurance</label> <select
								id="insurance-{{$index}}" ng-init="insuranceType='Self'"
								ng-model="insuranceType" ng-change="checkAdultAge(this,$index);"
								class="form-control insurnceSelect" name="insurance">
								<option value="Self">Self</option>
								<option value="Other">Other</option>
							</select>
						</div>

						<div class="col-md-12 col-sm-12 col-xs-12 displayNone"
							id="AdultNominees{{$index}}">
							<div class="col-md-6 col-sm-6 col-xs-6">
								<label>Nominee Name <input id="nomineeName-{{$index}}"></input>
								</label>
							</div>
							<div class="col-md-6 col-sm-6 col-xs-6">
								<label>Nominee Relationship <input
									id="nomineeRel-{{$index}}"></input>
								</label>
							</div>
						</div>
						<div class="col-md-12 col-sm-12 col-xs-12" id="rmDetailsExists-{{$index}}" style="display:none;">
						<!-- <div class="form-group clearfix" data-ng-if="empCode">
							<label for="inputEmail3">Employee Code</label> <input
								type="text" class="form-control" name="EmployeeCode-{{$index}}"  
								id="EmployeeCode-{{$index}}" placeholder="Employee code" required
								autocomplete="off"
								onkeypress="return isAlphabetKey(event,this);"
								data-ng-model="employeeCode" data-ng-required="true">
						</div> -->
						<div class="form-group clearfix" data-ng-if="empCode">
							<label for="inputEmail3">Employee Code</label> <input
								type="text" class="form-control" name="EmployeeCode-{{$index}}"  
						...
						<div class="form-group clearfix" data-ng-if="department">
							<label for="inputEmail3">Department</label> <input
								type="text" class="form-control" name="Department-{{$index}}"  
								id="Department-{{$index}}" placeholder="Department" required
								autocomplete="off"								
								data-ng-model="departmentModel" data-ng-required="true">
						</div>
						<div class="form-group clearfix" data-ng-if="costCenter">
							<label for="inputEmail3">Cost Center</label> <input
								type="text" class="form-control" name="CostCenter-{{$index}}"  
								id="CostCenter-{{$index}}" placeholder="costCenter" required
								autocomplete="off"								
								data-ng-model="costCenterModel" data-ng-required="true">
						</div>
						<div class="form-group clearfix" data-ng-if="apprName">
							<label for="inputEmail3">Approver Name</label> <input
								type="text" class="form-control" name="Approver-{{$index}}"  
								id="Approver-{{$index}}" placeholder="Approver Name" required
								autocomplete="off"								
								data-ng-model="approverName" data-ng-required="true">
						</div>
						<div class="form-group clearfix" data-ng-if="location">
							<label for="inputEmail3">location</label> <input
								type="text" class="form-control" name="Location-{{$index}}"  
								id="Location-{{$index}}" placeholder="location" required
								autocomplete="off"								
								data-ng-model="locationModel" data-ng-required="true">
						</div>
						<div class="form-group clearfix" data-ng-if="trNumber">
							<label for="inputEmail3">Tr Number</label> <input
								type="text" class="form-control" name="trNumber-{{$index}}"  
								id="trNumber-{{$index}}" placeholder="Tr Number" required
								autocomplete="off"								
								data-ng-model="trNumberModel" data-ng-required="true">
						</div>
						<div class="form-group clearfix" data-ng-if="bussinessUnit">
							<label for="inputEmail3">Bussiness Unit</label> <input
								type="text" class="form-control" name="businessUnit-{{$index}}"  
								id="businessUnit-{{$index}}" placeholder="bussinessUnit" required
								autocomplete="off"								
								data-ng-model="bussinessUnitModel" data-ng-required="true">
						</div>
						<div class="form-group clearfix" data-ng-if="projectCode">
							<label for="inputEmail3">ProjectCode</label> <input
								type="text" class="form-control" name="projectCode-{{$index}}"  
								id="projectCode-{{$index}}" placeholder="ProjectCode" required
								autocomplete="off" data-ng-model="projectCodeModel" data-ng-required="true">
						</div>
						<div class="form-group clearfix" data-ng-if="reasonForTravel">
							<label for="inputEmail3">Reason For Travel</label> <input
								type="text" class="form-control" name="reasonForTravel-{{$index}}"  
								id="reasonForTravel-{{$index}}" placeholder="reasonForTravel" required
								autocomplete="off"								
								data-ng-model="reasonForTravelModel" data-ng-required="true">
						</div>
						<div class="form-group clearfix" data-ng-if="billNonBill">
							<label for="inputEmail3">Bill Non Bill</label> <input
								type="text" class="form-control" name="billNonBill-{{$index}}"  
								id="billNonBill-{{$index}}" placeholder="billNonBill" required
								autocomplete="off"								
								data-ng-model="billNonBillModel" data-ng-required="true">
						</div>
						 
							<div class="form-group clearfix" data-ng-repeat="(index,dynmField) in dynamicFields">
								<!--  <div class="biiling-bd2"> -->
		                   <!--  <div class="form-group clearfix bii-bd"> -->
		                      <label for="exampleInputName2 " >{{dynmField.manualField}}</label>
		                      <input type="text" class="form-control"
		                        name="manual{{index}}{{$parent.$index}}" id="manual{{index}}{{$parent.$index}}"
		                        ng-attr-placeholder="{{dynmField.manualField}}" autocomplete="off">
		                   <!--  </div> -->
		                  <!-- </div> -->
						</div>
						
						<!-- <div class="form-group clearfix" data-ng-if="manualDetails">
							<label for="inputEmail3">Manual</label> <input
								type="text" class="form-control" name="adlN"  
								id="projectCode-{{$index}}" placeholder="ProjectCode" required
								autocomplete="off"
								onkeypress="return isAlphabetKey(event,this);"
								data-ng-model="projectCode" data-ng-required="true">
						</div> -->
						</div>
						...
						<div class="col-sm-12 col-xs-12 clearfix pad-LR-Zero">
							<div class="col-md-6 col-sm-6 col-xs-12 clearfix pad-LR-Zero"
								...
								<label class="dep-meal mobileDeap-meal"><a
									...
									aria-expanded="false" aria-controls="departure"
									class="collapsed"> Departure Meal/Seat Selection </a></label>
							</div>
							<div class="col-md-6 col-sm-6 col-xs-12 clearfix pad-LR-Zero"
								...
								<label class="dep-meal"><a data-toggle="collapse"
									...
									aria-controls="departure">Arrival Meal/Seat Selection </a></label>
							</div>
						</div>
					...
					<div class="adult clearfix mob-Adult"
						...
						<div class="form-group newClearFix clearfix dateLength">
							...
							<input type="text" class="form-control datePickChild"
								id="childdate{{$index}}" placeholder="DOB"
								onkeydown="return false;" data-ng-required="true"
								data-ng-click="InsuranceChildcallApi($index)" />
						</div>

						<div class="form-group clearfix tile-bd"
							data-ng-show="Isinsurance && Isinsurance!=undefined">
							<label for="exampleInputName2">Insurance</label> <select
								id="chinsurance-{{$index}}" ng-init="chinsuranceType='Self'"
								ng-model="chinsuranceType"
								ng-change="checkChildAge(this,$index);"
								class="form-control insurnceSelect" name="insurance">
								<option value="Self">Self</option>
								<option value="Other">Other</option>
							</select>
						...
						<div class="col-md-12 col-sm-12 col-xs-12 displayNone"
							id="ChildNominees{{$index}}">
							<div class="col-md-6 col-sm-6 col-xs-6">
								<label>Nominee Name <input id="chNomineeName-{{$index}}"></input>
								</label>
							</div>
							<div class="col-md-6 col-sm-6 col-xs-6">
								<label>Nominee Relationship <input
									id="chNomineeRel-{{$index}}"></input>
								</label>
							</div>
						</div>
						...
						<div class="col-sm-12 col-xs-12 ">
							<div class="col-md-6 col-sm-6 col-xs-6"
								...
								<label class="dep-meal mobileDeap-meal"><a
									data-toggle="collapse" data-target="#childdeparture{{$index}}"
									aria-expanded="false" aria-controls="departure"
									class="collapsed"> Departure Meal/Seat Selection </a></label>
							</div>
								...
								<div class="collapse " id="childdeparture{{$index}}">
									<div>
										<div class="form-group clearfix"
											data-ng-if="meallist.length > 0 && IsLCC">
											<label>Meal</label> <select class="form-control "
												name="chmealcode" id="mealitem-{{$index}}"
												onchange="addprice('childmeal',this);">
												<option data-ng-repeat="meal in meallist"
										...
										<div>
											...
											<div class="form-group clearfix" id="bag"
												...
												<label>Extra Baggage</label> <select class="form-control"
													name="chbaggagecode" id="Chbaggitem-{{$index}}"
					...
					<div class="adult clearfix mob-Adult"
						...
						<div class="form-group newClearFix clearfix dateLength">
							<label for="inputEmail3">Date of birth</label> <input type="text"
								...
								onkeydown="return false;" placeholder="DOB"
								data-ng-required="true"
								data-ng-click="InsuranceInfantcallApi($index)" />
						</div>
						<div class="form-group clearfix tile-bd"
							data-ng-show="Isinsurance && Isinsurance!=undefined">
							<label for="exampleInputName2">Insurance</label> <select
								id="InfantInsurance-{{$index}}"
								ng-init="InfantInsuranceType='Self'"
								ng-model="InfantInsuranceType"
								ng-change="checkInfantAge(this,$index);"
								class="form-control insurnceSelect" name="insurance">
								<option value="Self">Self</option>
								<option value="Other">Other</option>
							</select>
						</div>
						<!-- <div class="col-md-12 col-sm-12 col-xs-12" id="other-div" data-ng-show="ChildNomineDetails"> -->
						<div class="col-md-12 col-sm-12 col-xs-12 displayNone"
							id="InfantNominees{{$index}}">
							<div class="col-md-6 col-sm-6 col-xs-6">
								<label>Nominee Name <input
									id="InfNomineeName-{{$index}}"></input>
								</label>
							</div>
							<div class="col-md-6 col-sm-6 col-xs-6">
								<label>Nominee Relationship <input
									id="InfNomineeRel-{{$index}}"></input>
								</label>
							</div>
						</div>
			...
			<div class="panel panel-default traveler-details">
				<div class="panel-heading padding10px ">
					<h3 class="panel-title display-td">Contact Details</h3>
				</div>
				<div class="panel-body biil-bd">
					...
					<div class="biiling-bd2 mobViewFullDiv">
						<div class="form-group clearfix bii-bd">
					...
					<s:if
						...
						<div class="padding15px">
							<div class="row">
									...
									<div class="biiling-bd2" data-ng-if="department">
										<div class="form-group clearfix bii-bd">
											<label for="exampleInputName2">Department</label> <input
												...
												ng-model="dePart" data-ng-required="true" autocomplete="off">
										</div>
									</div>
									...
									<div class="biiling-bd2" data-ng-if="costCenter">
										<div class="form-group clearfix bii-bd">
											<label for="exampleInputName2">Cost Center</label> <input
												...
												ng-model="CostCen" data-ng-required="true"
												autocomplete="off">
										</div>
									</div>
									<div class="biiling-bd2" data-ng-if="approverName">
										<div class="form-group clearfix bii-bd">
											<label for="exampleInputName2">Approver Name</label> <input
												...
												ng-model="Appr" data-ng-required="true" autocomplete="off">
										</div>
									</div>
									...
									<div class="biiling-bd2" data-ng-if="location">
										<div class="form-group clearfix bii-bd">
											<label for="exampleInputName2">Location</label> <input
												...
												ng-model="Loc" data-ng-required="true" autocomplete="off">
										</div>
									</div>
									<div class="biiling-bd2" data-ng-if="trNumber">
										<div class="form-group clearfix bii-bd">
											<label for="exampleInputName2">TR Number</label> <input
												...
												ng-model="trNo" data-ng-required="true" required
												autocomplete="off">
										</div>
									</div>
									...
									<div class="biiling-bd2" data-ng-if="bussinessUnit">
										<div class="form-group clearfix bii-bd">
											<label for="exampleInputName2">Business unit</label> <input
												...
												placeholder="Business unit" ng-model="busiUnit"
												data-ng-required="true" autocomplete="off">
										</div>
									</div>
									<div class="biiling-bd2" data-ng-if="projectCode">
										<div class="form-group clearfix bii-bd">
											<label for="exampleInputName2">Project Code</label> <input
												...
												placeholder="Project Code" ng-model="projCode"
												data-ng-required="true" autocomplete="off">
										</div>
									</div>
									...
									<div class="biiling-bd2" data-ng-if="billNonBill">
										<div class="form-group clearfix bii-bd">
											...
											<input type="text" class="form-control NameFontMAnl"
												...
												placeholder="Billable/ non billable" ng-model="billCode"
												data-ng-required="true" autocomplete="off">
										</div>
									</div> -->
								</s:if>
								...
								<div
									data-ng-repeat="(index,manual) in ManulaFieldList track by $index">
					...
					<s:if test="#session.isLabeling == true">
						<s:if test="#session.isCardAcess == true">
							<div id="radioDiv" style="visibility: hidden;">
							...
							<div class="col-sm-12 col-sm-12 col-xs-12 clearfix select-opt">
								<div class="form-group clearfix">
									<label><b>Select Payment Option</b></label><br> <span
										class="radWallet"> <input type="radio"
			...
			<div class="panel panel-default traveler-details"
				data-ng-show="insuranceExist">
				<div id="checkIns">
					<input type="checkbox" name="MyCheckBox" id="MyCheckBox"
						ng-model="addInsuranceCheckModel.value" ng-change="Insuranceadd()" />Yes,Add
					travel Insurance to Protect my trip
				</div>
				<div id="ShowMeDIV" style="display: none;">

					<div class="panel-heading padding10px insurancePanel">
					...
					<div class="panel-body biil-bd">
							...
							<div class="col-md-12 col-sm-12 col-xs-12 padLeftRight0px margin-btm12px">
						<%-- 	<div class="col-md-6 col-sm-6 col-xs-6">							 
							<input type="checkbox" ng-model="InsuranceTermCheckModel.value"
								ng-change="Insurancechange()"><span class="coveragedata">Secure your trip with TrawellTag Cover-More.<br/>
															<span><i data-ng-class="classname"></i>{{InsurancePrice}} per Passenger</span></span>
				 			</div> --%>
				 				<div class="col-md-4 col-sm-4 col-xs-12 padLeftRight0px">	
				 				Travel Assistance Including Insurance 				 
							</div>
				 			<div class="col-md-8 col-sm-8 col-xs-12 padLeftRight0px">
				 			<div>
				 			<input type="checkbox" ng-model="InsuranceTermCheckModel.value"
								ng-change="Insurancechange()"> <span class="coveragedata "><b class="tripFont">Secure your trip with TrawellTag Cover-More. </b>
															<p class="padLeftIns10px font13"><span><i data-ng-class="classname"></i>{{insurancePerPassenger|number : 2}} per Passenger</span></p>
															</span>
				 			
							 </div>
				 			<div >
				 			<input type="checkbox"  id="uncheckInsurance"
								ng-click="InsuranceNotchange()"><span class="coveragedata font600">No, I do not wish to purchase travel Assistance including Insurance.</span>
							<p class="font13">Please Note: Travel assistance including insurance is highly recommended.</p>
				 			</div>
				 			
							  </div>
							</div>
						<div class="InsuranceBlocks">
							<ul class="insuranceUL">
								<li><img class="resizing img-responsive" alt=""
									src="./images/insCancel.png"></li>
								<li><img class="resizing img-responsive" alt=""
									src="./images/insDelay.png"></li>
								<li><img class="resizing img-responsive" alt=""
									src="./images/insBaggae.png"></li>
								<li><img class="resizing img-responsive" alt=""
									src="./images/insEmergency.png"></li>								
							</ul>
							<ul class="insuranceContent ">
								<li><div class="font600">Trip Cancellation</div></li>
								<li><div class="font600">Flight Delay</div>	</li>
								<li><div class="font600">Loss of Baggae</div></li>
								<li><div class="font600">Medical Emergency</div></li>
								

							</ul>

							<div id="showInsurConditions" class="col-md-12 col-sm-12 col-xs-12 marginTravel">
							<div class="col-md-1 col-sm-1 col-xs-1" >
							<input type="checkbox" data-ng-model="checked" data-ng-required="true">
							</div>
							<%-- <div class="col-md-11 col-sm-11 col-xs-11" >
							<p>I hereby confirm that all persons covered are citizens of india and below 70 years of age.<p>
								<p>I have read and understood the <span><a data-ng-click="InsproductBenefits()">Product Benefits</a></span>
								and <span><a data-ng-click="insurancePage()">Terms and
										Conditions</a></span></p>
							 </div>	 --%>	
							 <div class="col-md-11 col-sm-11 col-xs-11" >
							<p>I hereby confirm that all persons covered are citizens of india and below 70 years of age.<p>
								<p>I have read and understood the <span><a class="handCursr" data-ng-click="InsproductBenefits()">Product Benefits</a></span>
								and <span><a class="handCursr" data-ng-click="insurancePage()">Terms and
										Conditions</a></span></p>
							 </div>							
							</div>							
						</div>
			...
			<div class="panel panel-default traveler-details">
				<div class="panel-heading padding10px ">
					<h3 class="panel-title display-td">Terms & Conditions</h3>
				</div>
				<div class="panel-body biil-bd">
								...
								<s:else>
									<s:if test="#session['agent'] != null">
										<button id="wallentOption" type="submit"
											data-ng-click="corporateFlightBook()"
										...
										<button id="cardOption" type="submit"
											data-ng-click="AgentFlightCardBook()"
											class="btn btn-primary but book-btn"
											data-ng-disabled="ImageLoader">
											Proceed <i class="fa fa-arrow-circle-right"></i><span
												data-ng-show="ImageLoader"><img
									...
									<s:else>
										...
										<button id="paybooksubmit" type="submit"
											data-ng-click="userBookingPreview()"
											class="btn btn-primary but book-btn"
											data-ng-disabled="ImageLoader">
...
/* 	 $(document).ready(function(){
	...
	t($.ui.autocomplete.filter(s,e.term))}})},select:function(e,t){var a=e.target.id.substring(12,13);return void 0!=t.item.email&&$("#email").val(t.item.email),$("#"+e.target.id).val(t.item.value),$("#Surname-"+a).val(t.item.lastname),$("#mrMss"+a).val(t.item.title),$("#mobile").val(t.item.mobileno),$("#passport-"+a).val(t.item.passportno),!1}})
					...
					source:function(e,t){
						 ...
						 var completeUrl = apiUrl+'employee/list';						
								...
								select:function(e,t){
									...
									var a=e.target.id.substring(12,13);
									callApi(e.target.id,t.item.empCode,a);
									
									return void 0!=t.item.email&&$("#email").val(t.item.email),
										$("#"+e.target.id).val(t.item.value),
										$("#Surname-"+a).val(t.item.lastname),																				 
		...
		function callApi(empRow,empId,rowIndex){	
			 angular.element(document.getElementById(empRow)).scope().getRmdetails(rowIndex,empId);
		 }	 
