...
<s:if test="#session.isLabeling != true">
	<s:if test="#session['agent'] != null">
		...
		<input type="text" name="thm" id="themeType"
			value="<s:property value="%{#session.ThemeName}"/>">

	</s:if>
</s:if>
<s:if test="#session.isHeaderEnabled == false">
			...
			<div class="row">
				...
				<div class="col-xs-3 col-sm-7 col-md-6">
					...
					<div class="header-top-first clearfix">
						<s:if test="#session.isSocialMediaEnabled == true">
						...
						<div class="header-top-dropdown text-right">
							...
							<ul>
								...
								<s:elseif test="#session['agent'] != null">
									...
									<li class="dropdown">
										<div
											data-ng-if="<s:property value="%{#session.isLabeling}"/> == true">
										</div>
										<div
											data-ng-if="<s:property value="%{#session.isLabeling}"/> != true">

										</div> <a href="#" class="dropdown-toggle" data-toggle="dropdown">Welcome
									...
									<li><span>Credit:&nbsp;<i
											...
											class="" id="agentDepbal" value="" data-ng-bind="agentDepbal"></span></span></li>
								...
								<li><s:if test="#session.isLabeling == true">
										<a class="logout-form"><i class="tayyarah-sign-out"></i>Default
											Theme</a>
									</s:if></li>
								<%--  </s:else> --%>
							</ul>
...
<s:if test="#session.isHeaderEnabled == true">
					...
					<div class="col-xs-3 col-sm-7 col-md-6">
						...
						<div class="header-top-first clearfix">
							...
							<ul class="list-inline">
								<li><i class="tayyarah-phone pr-5 pl-10"></i> 080-42855555</li>
								<li><a id="emailLnk" href="#"><i
										class="tayyarah-envelope-o pr-5 pl-10"></i> care@tayyarah.com
								</a></li>
							</ul>
						</div>
					</div>
						...
						<div class="logo">
							<h1>
								<a data-ng-href="#flights" data-ng-click="returnIndex()"> <img
									src={{WhiteLabelLogo}} class="img-responsive logoImage"
									alt="tayyarah"></a> <a class="imgSiz" data-ng-href="#flights"
						...
						<div class="nav-bag clearfix">
							<div class="collapse navbar-collapse navbar-ex1-collapse ">
								<ul
									...
									<s:if test="#session.isBusEnabled == true">
										<li data-ng-class="{ active: isActive('/bus')}"><a
											data-ng-href="#/bus" data-ng-click="returnBusIndex()"
											return="false"><i class="visible-xs-inline"></i><img
									...
									<s:if test="#session.isAboutUSEnabled == true">
								...
								<ul
									...
									<li data-ng-class="{ active: isActive('/bus')}"><a
										data-ng-href="#/bus"><i class="visible-xs-inline"></i><img
											class="busimg  "></img> <Span>Bus</Span></a></li>
									<li data-ng-class="{ active: isActive('/cars')}"><a
									...
									<s:if test="#session['agent'] == null">
										<li><a data-toggle="modal" data-target="#welcomeagent"
									...
									<div class="dropdown-menu dropNotification dropdown-menu-lg ">
										...
										<div class="dropdown-body">
											<div class="custom-scrollable-area">
												<ul
													class="list-group list-group-divided customNew-scrollbar">
