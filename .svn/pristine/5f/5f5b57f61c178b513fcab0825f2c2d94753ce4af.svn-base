...
<div class="col-md-12 ">
	...
	<div class="col-md-12 mainCon" data-ng-style="{'display' : display}"
		data-ng-cloak>
		...
		<div class="booking-details clearfix">
			...
			<div class="col-md-12 col-sm-12 col-xs-12 padding-0px ">
				...
				<div class="clearfix fareDet visible-xs">
							...
							<div class="col-sm-3">
								<figure>
									<img src="{{hotelimage}}" alt="hotelimage"
										class="img-responsive" width="305px" height="305px;">
								</figure>
							</div>
					...
					<form class="form clearfix" name="hotelSummary">
							...
							<div class="panel-body">
								<div class="col-sm-12"
									...
									<div class="adult clearfix"
										...
										<div class="col-md-12 col-sm-12 col-xs-12" id="room-{{roomindex}}-rmDetails-{{adultindex}}" style="display:none;">
						<!-- <div class="form-group clearfix" data-ng-if="empCode">
							<label for="inputEmail3">Employee Code</label> <input
								type="text" class="form-control" name="empcode"  
								id="room-{{roomindex}}-pass-{{adultindex}}-empCode" placeholder="Employee code" required
								autocomplete="off"
								onkeypress="return isAlphabetKey(event,this);"
						...
						<div class="form-group clearfix" data-ng-if="department">
							<label for="inputEmail3">Department</label> <input
								...
								id="room-{{roomindex}}-pass-{{adultindex}}-department" placeholder="Department" required
								autocomplete="off"								
						...
						<div class="form-group clearfix" data-ng-if="costCenter">
							<label for="inputEmail3">Cost Center</label> <input
								type="text" class="form-control" name="adlN"  
								id="room-{{roomindex}}-pass-{{adultindex}}-costCenter" placeholder="costCenter" required
								autocomplete="off"								
						...
						<div class="form-group clearfix" data-ng-if="apprName">
							<label for="inputEmail3">Approver Name</label> <input
								type="text" class="form-control" name="adlN"  
								id="room-{{roomindex}}-pass-{{adultindex}}-approverName" placeholder="Approver Name" required
								autocomplete="off"								
						...
						<div class="form-group clearfix" data-ng-if="location">
							<label for="inputEmail3">location</label> <input
								type="text" class="form-control" name="adlN"  
								id="room-{{roomindex}}-pass-{{adultindex}}-location" placeholder="location" required
								autocomplete="off"							
						...
						<div class="form-group clearfix" data-ng-if="trNumber">
							<label for="inputEmail3">Tr Number</label> <input
								type="text" class="form-control" name="adlN"  
								id="room-{{roomindex}}-pass-{{adultindex}}-trNumber" placeholder="Tr Number" required
								autocomplete="off"								
						...
						<div class="form-group clearfix" data-ng-if="bussinessUnit">
							<label for="inputEmail3">Bussiness Unit</label> <input
								type="text" class="form-control" name="adlN"  
								id="room-{{roomindex}}-pass-{{adultindex}}-bussinessUnit" placeholder="bussinessUnit" required
								autocomplete="off"								
						...
						<div class="form-group clearfix" data-ng-if="projectCode">
							<label for="inputEmail3">ProjectCode</label> <input
								type="text" class="form-control" name="adlN"  
								id="room-{{roomindex}}-pass-{{adultindex}}-projectCode" placeholder="ProjectCode" required
								autocomplete="off"								
								data-ng-model="projectCodeModel" data-ng-required="true">
						</div>
						<div class="form-group clearfix" data-ng-if="reasonForTravel">
							<label for="inputEmail3">Reason For Travel</label> <input
								type="text" class="form-control" name="adlN"  
								id="room-{{roomindex}}-pass-{{adultindex}}-reasonForTravel" placeholder="reasonForTravel" required
								autocomplete="off"								
						...
						<div class="form-group clearfix" data-ng-if="billNonBill">
							<label for="inputEmail3">Bill Non Bill</label> <input
								type="text" class="form-control" name="adlN"  
								id="room-{{roomindex}}-pass-{{adultindex}}-billNonBill" placeholder="billNonBill" required
								autocomplete="off"								
								data-ng-model="billNonBillModel" data-ng-required="true">
						</div>
						 
						<div class="form-group clearfix" data-ng-repeat="(index,dynmField) in dynamicFields track by $index">
								 <div class="biiling-bd2">
		                    <div class="form-group clearfix bii-bd">
		                      <label for="exampleInputName2 " class="NameFontMAnl">{{dynmField.manualField}}</label>
		                      <input type="text" class="form-control NameFontMAnl"
		                        name="billingCode" id="room-{{roomindex}}-pass-{{adultindex}}-manual-{{index}}"
							...
							<div class="panel panel-default traveler-details ">
								...
								<div class="panel-body biil-bd">
									...
									<div class="biiling-bd2 billMob mobViewFullDiv">
										<div class="form-group clearfix bii-bd">
									...
									<s:if test="#session['agent'] != null">
										<div class="biiling-bd2 billEm mobViewFullDiv">
											<div class="form-group clearfix ">
												...
												<div class="biiling-bd2" data-ng-if="isDepartment">
													<div class="form-group clearfix bii-bd">
														<label for="exampleInputName2">Department</label> <input
															...
															placeholder="Department" ng-model="dePart" required
												...
												<div class="biiling-bd2" data-ng-if="isCostCenter">
													<div class="form-group clearfix bii-bd">
														<label for="exampleInputName2">Cost Center</label> <input
															...
															placeholder="Cost Center" ng-model="CostCen" required
															autocomplete="off" data-ng-required="true">
													</div>
												</div>
												<div class="biiling-bd2" data-ng-if="isApprover">
													<div class="form-group clearfix bii-bd">
														<label for="exampleInputName2">Approver Name</label> <input
															...
															ng-model="Appr" required autocomplete="off"
															data-ng-required="true">
													</div>
												...
												<div class="biiling-bd2" data-ng-if="isLocation">
													<div class="form-group clearfix bii-bd">
														<label for="exampleInputName2">Location</label> <input
															...
															ng-model="Loc" required autocomplete="off"
															data-ng-required="true">
													</div>
												</div>
												<div class="biiling-bd2" data-ng-if="isTrNumber">
													<div class="form-group clearfix bii-bd">
														<label for="exampleInputName2">TR Number</label> <input
															...
															ng-model="trNo" required autocomplete="off"
															data-ng-required="true">
													</div>
												</div>
												<div class="biiling-bd2" data-ng-if="isBussinessUnit">
													<div class="form-group clearfix bii-bd">
														<label for="exampleInputName2">Business unit</label> <input
															...
															placeholder="Business unit" ng-model="busiUnit" required
															autocomplete="off" data-ng-required="true">
													</div>
												</div>
												<div class="biiling-bd2" data-ng-if="isProjectCode">
													<div class="form-group clearfix bii-bd">
														<label for="exampleInputName2">Project Code</label> <input
															...
															placeholder="Project Code" ng-model="projCode" required
															autocomplete="off" data-ng-required="true">
													</div>
												</div>
												...
												<div class="biiling-bd2" data-ng-if="isBillNon">
													<div class="form-group NameFontMAnlclearfix bii-bd">
														<label for="exampleInputName2">Billable/ non
															...
															id="billingCode" ng-model="billCode"
			...
			$("#0-adult-0-fname,#0-adult-1-fname,#0-adult-2-fname,#0-adult-3-fname,#1-adult-0-fname,#1-adult-1-fname,#1-adult-2-fname,#1-adult-3-fname,#2-adult-0-fname,#2-adult-1-fname,#2-adult-2-fname,#2-adult-3-fname,#3-adult-0-fname,#3-adult-1-fname,#3-adult-2-fname,#3-adult-3-fname").autocomplete({
			 ...
			 response($.ui.autocomplete.filter(array, request.term));
			        ...
			        select: function (event, ui) {			        	
			           ...
			           $('#'+index+'-adult-'+adindex+'-gender').val(ui.item.title);
			           $('#'+index+'-adult-'+adindex+'-lname').val(ui.item.lastname);
			           callApi(index,adindex,event.target.id,ui.item.empID);
			           return false;
			        },
			    });
			 }
			  });  
	   function callApi(roomIndex,passIndx,rowId,empID){	
		   console.log('roomIndex',roomIndex);
		   console.log('passIndx',passIndx);
		   console.log('rowId',rowId);
		   
			//angular.element(document.getElementById(rowIndex)).scope().getRmdetails(indx,empId);
		   angular.element(document.getElementById(rowId)).scope().getRmdetails(roomIndex,passIndx,empID);
			}	
