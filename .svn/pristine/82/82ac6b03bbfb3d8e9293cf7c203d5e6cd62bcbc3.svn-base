...
<div class="col-sm-9 searched-result mainContentHeight500px" id="two">
	<div class="scrollTrails">
		...
		<div class="clearfix intMobMod displayRigthPAd padLeftDom10px"
				...
				<s:if
					...
					<div class="sort-by-section clearfix box">
						<div class="col-sm-12 clearfix">
							<ul class="sort-bar clearfix mobOffFilter">
								...
								<li><a class="sort-by-container">
										<form class="form-inline">
											<label class="intCurrncy">Currency</label> <select
												id="selectcurrencyname" class="form-control intlcurrency"
			...
			<div class="row mobRemoveRightMargin"
				...
				<div class="col-md-10 col-sm-10 col-xs-10 clearfix">
					<div class="row">
						<div class="col-md-2 col-sm-2 col-xs-3 searched-city mobMrginTop">
							<p>
								<b>{{origincodename}} <i class="tayyarah-arrows-h"></i>
									{{destcodename}}
								</b>
						...
						<div
							class="col-md-4 col-sm-4 col-xs-6 searched-date mob-padRemove">
							<div class="row">
						...
						<!-- searched-date -->
						<div class="col-md-5 col-sm-5 col-xs-2 searched-economy cabinPAd ">
							<div
				...
				<div class="col-md-2 col-sm-2 col-xs-1 margin">
							...
							<div id="fareflightlist{{groupindex}}"
								...
								<div class="flb mobCompBorder clearfix">
									<div class="col-md-10 col-sm-10 col-xs-12 Mobdiv pad-LR-Zero">
										...
										<div class="round-trip intrn-trip"
											...
											<div class="flight-timings col-xs-12 newFlightTiming">
												...
												<s:if test="#session['agent'] != null">
													<div
														...
														<form class="col-xs-12 padZeropx"
											...
											<div class="showviews">
												...
												<div class="tab-content" id="mode-cont">
															...
															<div class="model-main-details"
																...
																<div class="d-h-air">
																	<ul class="mod-f-details clearfix">
																		...
																		<li class="col-xs-12 module-direction mobLi100Per">
																			<h5>
																				<i class="tayyarah-clock-o"></i>
																				{{duration[segindex]}}
																			</h5> <span>0 Stop</span>
													...
													<div role="tabpanel" class="tab-pane" id="messages">
														...
														<div class="clearfix">
															<div class="col-sm-6 col-xs-6 m-baggage">
