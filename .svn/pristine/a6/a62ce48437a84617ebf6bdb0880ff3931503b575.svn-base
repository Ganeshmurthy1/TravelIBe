...
<div class="container">
	...
	<div class="container borderGrey marginTop15Per busPAdZero">
		...
		<div class="col-md-12 col-sm-12 col-xs-12 padding15px">
			...
			<div class="col-xs-3 hidden-xs containerbusico">
				<a class="buslisticon"></a>
			</div>


			<div class="col-md-4 col-sm-4 col-xs-9 busPAdZero">
				...
				<span class="col-md-8 col-sm-8 col-xs-12 busPAdZero"> <span
					class="col-md-12 col-sm-12 col-xs-6 font600"
					data-ng-bind="busOperator"></span> <span
					class="col-md-12 col-sm-12 col-xs-6" data-ng-bind="busType"></span>

				</span>

			</div>
			<div class="col-md-2 col-sm-2 col-xs-5 text-center captilazie"
				data-ng-bind="origin"></div>
			<div class="col-md-1 col-sm-1 col-xs-1 busPAdZero">
				<div class="text-center">
					<span><i class="tayyarah-long-arrow-right"></i></span>
				</div>
				<div class="text-center" data-ng-bind="onwardDate"></div>
			</div>
			<div class="col-md-2 col-sm-2 col-xs-5 text-center captilazie"
	...
	<div class="container borderGrey padding-0px marginBtm5per">
		<div class="col-md-9 col-sm-9 col-xs-12 bodymin-height ">
			<div
				...
				<div
					...
					<div class="col-md-6 col-sm-6 col-xs-12 borderedRight">
						<div
							...
							Point</div>
						<div
							class="col-md-9 col-sm-9 col-xs-12 text-center padding5px captilazie"
							data-ng-bind="boarding"></div>
						<div class="col-md-3 col-sm-3 col-xs-12 text-center padding5px"
		...
		<div
			...
			<div class="col-md-12 col-sm-12 col-xs-12 passFare">
				...
				<!--<p class="col-md-8 col-sm-8 col-xs-8">Passengers (1)</p><p class="col-md-4 col-sm-4 col-xs-4 pull-right textRight">700</p>
 ...
 -->
				...
				<s:if test="#session.isCorporate == true">
					...
					<div data-ng-show="GSTServiceTaxes">
						...
						<p class="col-md-4 col-sm-4 col-xs-4 pull-right textRight">{{CGSTTax|
							number : 2}}</p>
						<p class="col-md-8 col-sm-8 col-xs-8">SGST</p>
						<p class="col-md-4 col-sm-4 col-xs-4 pull-right textRight">{{SGSTTax|
							number : 2}}</p>
						<p class="col-md-8 col-sm-8 col-xs-8">IGST</p>
						<p class="col-md-4 col-sm-4 col-xs-4 pull-right textRight">{{IGSTTax|
							number : 2}}</p>
						<p class="col-md-8 col-sm-8 col-xs-8">UGST</p>
						<p class="col-md-4 col-sm-4 col-xs-4 pull-right textRight">{{UGSTTax|
							number : 2}}</p>
						<p class="col-md-8 col-sm-8 col-xs-8">GST</p>
						<p class="col-md-4 col-sm-4 col-xs-4 pull-right textRight">{{GSTTax|
							number : 2}}</p>
						<p class="col-md-8 col-sm-8 col-xs-8">Management Fee</p>
						<p class="col-md-4 col-sm-4 col-xs-4 pull-right textRight">{{managementFee|
							number : 2}}</p>
					</div>
				</s:if>
				<s:else>
				...
				<div class="col-md-12 col-sm-12 col-xs-12 padding-0px"
					id="convienceCharges">
					<p class="col-md-8 col-sm-8 col-xs-8">convience Fee</p>
					<p class="col-md-4 col-sm-4 col-xs-4 pull-right textRight"
