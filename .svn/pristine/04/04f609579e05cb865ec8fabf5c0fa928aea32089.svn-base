...
<div class="SessionTemplate">
   ...
   <div class="visible-xs gradient" data-ng-show="loadpricebar">
	...
	<div class="mobMrginTop marginTop18px"  data-ng-style="{'display' : maincontainer}">
		<div class="clearfix">
			<div class="col-sm-3 offcanvas" id="one">
			<div id="fixingPosition" class="fixedPosition">
				<div class="closebtn done">
				<span class="pull-left padLR0POneway">
								...
								<div class="panel-body">
									<form class="form-horizontal " role="form">
										<div class='priceslider'>
											...
											<span><b class="text-left" id="departMin"></b></span><span
												><b class="pull-right" id="departMax"></b></span>
								...
								<div class="panel-body">
									<form class="form-horizontal " role="form">
										<div class='priceslider'>
											...
											<span><b class="text-left" id="seconddepartMin"></b></span><span
												><b class="pull-right" id="seconddepartMax"></b></span>
