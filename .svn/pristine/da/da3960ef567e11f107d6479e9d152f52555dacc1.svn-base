...
<div class=" minheight500px" data-ng-cloak>
	<div class="row">
		<div class="col-md-2 col-sm-3 offcanvas" id="busone"
			data-ng-show="leftmenuloader">

			<div>
				<div class="closebtn done">
					<button class="offcanvas__trigger--close btn" data-rel="busone">Done</button>
				</div>
				<div id="fixingPosition" class="fixedPosition">
					<aside class="clearfix busLeftTopMargin">
								...
								<div class="panel-heading" role="tab" id="headingOne">
									<h4 class="panel-title">
										<a role="button" data-toggle="collapse"
											...
											class="accordion" aria-controls="collapseOne"> Prices <span><i
												class="tayy tayyarah-keyboard_arrow_right"></i></span>
										</a>
									</h4>
								</div>
								...
								<div class="panel-heading" role="tab" id="headingFive">
									<h4 class="panel-title">
										<a class="collapsed" role="button" data-toggle="collapse"
											...
											aria-controls="collapseThree"> Bus Type<span><i
												class="tayy tayyarah-keyboard_arrow_right"></i></span>
										</a>
									</h4>
								</div>
									...
									<div class="panel-body">
										...
										<div class="checkbox" data-ng-repeat="bustype in bustypelist">
											<label> <input type="checkbox" value="{{bustype}}"
												...
												<span class="searchcheck-b">{{bustype}} </span>
											</label>
										</div>
									</div>
								</div>
								...
								<div class="panel-heading" role="tab" id="headingThree">
									<h4 class="panel-title">
										<a class="collapsed" role="button" data-toggle="collapse"
											...
											aria-controls="collapseThree"> Boarding Point <span><i
												class="tayy tayyarah-keyboard_arrow_right"></i></span>
										</a>
									</h4>
								</div>
									...
									<div class="panel-body">
										...
										<div class="checkbox"
											...
											<label> <input type="checkbox" value="{{blocation}}"
												...
												data-ng-model="todo"> <span
												class="checkbox-material"><span class="check"></span></span>
												<span class="searchcheck-b">{{blocation}} </span>
											</label>
										</div>
									</div>
								</div>
								...
								<div class="panel-heading" role="tab" id="headingFour">
									<h4 class="panel-title">
										<a class="collapsed" role="button" data-toggle="collapse"
											...
											aria-controls="collapseFour"> Dropping Point <span><i
												class="tayy tayyarah-keyboard_arrow_right"></i></span>
										</a>
									</h4>
								</div>
									...
									<div class="panel-body">
										<div class="checkbox"
											...
											<label> <input type="checkbox" value="{{dlocation}}"
												...
												data-ng-model="todo"> <span
												class="checkbox-material"><span class="check"></span></span>
												<span class="searchcheck-b">{{dlocation}} </span>
											</label>
										</div>
									</div>
								</div>
