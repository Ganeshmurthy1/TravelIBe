							...
							<div class="booking-box">
								...
								<ul class="booking-fare-details">
									<div data-ng-show="GSTServiceTaxes">
										<li class="gstNumb">GST Number<span class="pull-right"
											data-ng-style="{ 'display' : isfareloaded}">
												{{gstNumber}} </span><span id="leftloading"
											data-ng-show="farebeforeload"> <img
									...
									<div data-ng-show="GSTServiceTaxes">
										...
										<%-- <li >GST <span class="pull-right" data-ng-style="{ 'display' : isfareloaded}">
								<i data-ng-class="classname"></i>{{GSTTax}}</span><span id="leftloading" data-ng-show="farebeforeload">
								<img src="images/priceloadingsmall.gif" class="pricesmallload"></span>
								</li>  --%>
										<li class="flightmanagement">Management Fee<span
											class="pull-right"
											data-ng-style="{ 'display' : isfareloaded}"> <i
									...
									<li data-ng-show="otherchargesB2C != undefined"
										id="B2Bothercharges">Convenience Fee<span
									...
									<li data-ng-show="IsLCC && IsLCC!=undefined">Extra Baggage<span>
										...
										id="leftloading" data-ng-show="farebeforeload"><img
											src="images/priceloadingsmall.gif" class="pricesmallload"></span></li>
									<li data-ng-show="Isinsurance && Isinsurance!=undefined">Insurance
										Fee<span> </span><span class="pull-right"
										data-ng-style="{ 'display' : isfareloaded}"><i
											data-ng-class="classname"></i>{{insuranceprice|number : 2}}</span><span
										id="leftloading" data-ng-show="farebeforeload"><img
											src="images/priceloadingsmall.gif" class="pricesmallload"></span>
									</li>
								...
								<input type="hidden" id="totalInsuranceFare"
									value="{{insuranceFlight}}" /> <input type="hidden"
									id="totalInsurancePayable" value="{{insurancetotalpayableamt}}" />
							</div>
						</div>
					</div>
					<!-- col-3 -->
