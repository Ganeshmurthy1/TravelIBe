...
<%@taglib prefix="s" uri="/struts-tags"%> 
		...
		<div class="offcanvas"   data-ng-show="leftmenuloader">
			<div id="fixingPosition" class="fixedPosition widthsideMenu">
							...
							<div class="panel-body">
								...
								<form class="form-horizontal " role="form">
									<div class='priceslider'>
										...
										<span><b class="text-left" id="arriMin"></b></span>
										<span ><b class="pull-right" id="arriMax"></b></span>
