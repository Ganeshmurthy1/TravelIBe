...
<article class="container">
    ...
    <div class="enhanced-datepicker">
		...
		<div ng-hide="loading">
			...
			<div ng-if="hotelbookinglists !=0 && hotelbookinglists !=undefined"
				class="col-sm-12">
				...
				<form class="form-inline" data-ng-submit="Bookingsearch()">
					...
					<div class=" col-md-12 home_class home_2">
						...
						<h4 class="col-md-12" style="padding-bottom: 15px;">Hotel
					...
					<div ng-if="hotelbookinglists !=0 && hotelbookinglists !=undefined"
						...
						<table id="mytable" class="table table-striped ddd"
							...
							<tbody>
								...
								<tr
									data-dir-paginate="(groupindex,hotel) in hotelbookinglists | itemsPerPage:10">
									<td>{{groupindex + 1}}.</td>
									<td>{{hotel.orderRef}}</td>
									<td>{{hotel.hotelName}}</td>
									<td>{{hotel.state}}</td>
									<td>{{hotel.hotel_cat}}</td>
									<td>{{hotel.checkInDate |date }}</td>
									<td>{{hotel.checkOutDate |date }}</td>
									<td>{{hotel.createdDate |date:'dd-MM-yyyy' }}</td>
									<!-- <td>{{hotel.arrivalTime}}</td>
     <td>{{hotel.bookingDate}}</td> -->
					...
					<div ng-if="hotelbookinglists ==0 || hotelbookinglists ==undefined">
						...
						<div class=" col-md-12 home_class home_2">
							...
							<h4 class="col-md-8">No Hotel Booking Data in Your Account</h4>
			...
			<div ng-if="!isdefaultHistory" class="col-sm-12 ">
				<div class="table-responsive dash-table clearfix">
					...
					<div
						ng-if="hotelbookingDatelists !=0 && hotelbookingDatelists !=undefined"
						class="box clearfix">
						<!-- <div class="box-body"> -->
						<table id="mytable" class="table table-striped ddd"
							data-sort-name="name" data-sort-order="desc">
							...
							<tbody>
								<tr
									data-dir-paginate="(groupindex,hotel) in hotelbookingDatelists | itemsPerPage:10">
									<td>{{groupindex + 1}}.</td>
									<td>{{hotel.orderRef}}</td>
									<td>{{hotel.hotelName}}</td>
									<td>{{hotel.state}}</td>
